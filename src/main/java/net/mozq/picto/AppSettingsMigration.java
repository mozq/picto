...
final class AppSettingsMigration {
	...
	private static final Map<String, String> RENAMED_KEYS = Map.ofEntries(
			...
			Map.entry("check.file.digest", "dest.check.file.digest"),
			...
			Map.entry("base.date.type", "changes.filedate.base.date.type"),
			Map.entry("custom.base.date", "changes.filedate.custom.base.date"),
			Map.entry("date.mod.type", "changes.filedate.adjustment.type"),
			Map.entry("date.mod.year", "changes.filedate.adjustment.years"),
			Map.entry("date.mod.month", "changes.filedate.adjustment.months"),
			Map.entry("date.mod.day", "changes.filedate.adjustment.days"),
			Map.entry("date.mod.hour", "changes.filedate.adjustment.hours"),
			Map.entry("date.mod.minute", "changes.filedate.adjustment.minutes"),
			Map.entry("date.mod.second", "changes.filedate.adjustment.seconds"),
